...
public final class Constants {
	...
	public static final String DB_MIDDLEWARE_HOST = System.getenv().getOrDefault("DB_MIDDLEWARE_HOST", "localhost");
	public static final String DB_MIDDLEWARE_PORT = System.getenv().getOrDefault("DB_MIDDLEWARE_PORT", "3001");
}