...
module.exports = {
    CONST_MONGO_DB_SERVER_URL:'mongodb://garuda_mongo:27017/garuda_mongodb', //garuda_mongodb is database name it creates the database automatically if it doesn't exists
    CONST_REQUEST_STATUS_IN_PROCESS: '0',
    CONST_REQUEST_STATUS_COMPLETE: '1',
    CONST_REQUEST_STATUS_ERROR: '2',

    CONST_NODE_JS_HOSTNAME:'0.0.0.0',
    CONST_NODE_JS_PORT:3001,
